...
public class ProcessingItemProviderAdapterFactory extends
    ...
    public Adapter createEffectSpecifyingReducingDataOperationAdapter() {
        if (effectSpecifyingReducingDataOperationItemProvider == null) {
            effectSpecifyingReducingDataOperationItemProvider = new EffectSpecifyingReducingDataOperationItemProvider(
                    this);
        }
        return effectSpecifyingReducingDataOperationItemProvider;
    }
