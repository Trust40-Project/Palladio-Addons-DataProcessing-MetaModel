/**
 */
package org.palladiosimulator.pcm.dataprocessing.dataprocessing.seff.util;
...
public class SeffSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case SeffPackage.DATA_SEFF_SPECIFICATION:
			{
				...
				if (result == null) result = caseEntity(dataSEFFSpecification);
				if (result == null) result = caseIdentifier(dataSEFFSpecification);
				if (result == null) result = caseNamedElement(dataSEFFSpecification);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data SEFF Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data SEFF Specification</em>'.
