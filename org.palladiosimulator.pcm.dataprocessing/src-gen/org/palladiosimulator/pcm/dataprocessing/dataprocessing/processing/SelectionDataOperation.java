 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL inputAndOutputHaveSameEntityType='self.input.type-&gt;oclAsSet() = self.output.type-&gt;oclAsSet() or self.input.type.oclAsType(pcm::repository::CollectionDataType).innerType_CollectionDataType-&gt;oclAsSet() = self.output.type-&gt;oclAsSet()'"
 * @generated
 */
